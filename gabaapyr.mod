...
modified by Alexandra Tzilivaki so as to include erver -50 based on Banke et al 2006 for CA3 pyramidal neurons
-----------------------------------------------------------------------------
ENDCOMMENT

NEURON {
	POINT_PROCESS GABAapyr
	RANGE R, g, gmax 
