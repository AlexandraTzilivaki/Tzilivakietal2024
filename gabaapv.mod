...
modified by Alexandra Tzilivaki so as to include erver -65 based on Banke et al 2006 for CA3 interneurons. Attention this is GABAa for dendrites not autaptic
-----------------------------------------------------------------------------
ENDCOMMENT

NEURON {
	POINT_PROCESS GABAapv
	RANGE R, g, gmax 
