...
def theta_filtered_spikes(rate, nrun, N, time, delay,
                          noise=0.03, f_theta=4, phi_theta=0,
    ...
    if save:
        foldername = f'fthetanTEST{rate}/run_{nrun}'
...
if __name__ == '__main__':
    spikes = theta_filtered_spikes(rate=300, #300 main figure 250 robustness protocol
                                   nrun=1,
                                   N=24,
                                   time=1100, #default 1100
                                   delay=100, 
                                   noise=0.0005,
                                   f_theta=4, #4 main figures 5 for robustness protocol
                                   phi_theta=0, #0 main figures 0.5 robustness protocol
                                   save=True,
                                   visualize=True)
